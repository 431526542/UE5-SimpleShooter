...
void AGun::PullTrigger()
{
	...
	UGameplayStatics::SpawnSoundAttached(MuzzlleSound, Mesh, TEXT("MuzzleFlashSocket"));
...
bool AGun::GunTrace(FHitResult& Hit, FVector& ShotDirection)
{
	...
	ShotDirection = -OutRotator.Vector();

	FVector End = OutLocation + OutRotator.Vector() * MaxRange;
	FCollisionQueryParams Params;
	Params.AddIgnoredActor(this);
	Params.AddIgnoredActor(GetOwner());
	return GetWorld()->LineTraceSingleByChannel(Hit, OutLocation, End,
